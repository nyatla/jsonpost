...
Mainチェーンは無限に伸長可能であり、Branchは終端があります。


Mainチェンーンはアカウントの生成を記録するチェーンです。
Branchはアカウントが生成される度にMainのチェーンを引き継いで生成し、ここに既知となったアカウントの操作履歴が追記されていきます。

アカウントはMainチェーンを操作することができません。
